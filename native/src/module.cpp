...
PYBIND11_MODULE(nimbleml_native, m) {
  ...
  m.def(
      ...
      [](py::array_t<float> grad, py::array_t<float> x, py::array_t<float> gamma, py::array_t<float> ms,
        ...
        nimbleml::rmsnorm_backward_cpu(static_cast<const float*>(grad.request().ptr), static_cast<const float*>(xbuf.ptr),
                                       static_cast<const float*>(gamma.request().ptr), static_cast<const float*>(ms.request().ptr),
                                       static_cast<const float*>(rms.request().ptr), static_cast<float*>(gx.ptr),
                                       static_cast<float*>(gg.ptr), rows, dim, eps);
  ...
  m.def(
      ...
      [](py::array_t<float> grad_w, py::array_t<std::int64_t> ids, py::array_t<float> grad_out) {
        ...
        nimbleml::embedding_scatter_add_cpu(static_cast<float*>(wbuf.ptr), static_cast<const std::int64_t*>(ibuf.ptr),
  ...
  m.def(
      ...
      [](py::array_t<float> logits, py::array_t<std::int64_t> labels) {
        ...
        float loss = 0.0f;
        nimbleml::crossentropy_forward_cpu(static_cast<const float*>(lbuf.ptr), static_cast<const std::int64_t*>(ybuf.ptr),
                                           static_cast<float*>(max_vals.request().ptr), static_cast<float*>(sum_exp.request().ptr),
                                           &loss, rows, classes);
  ...
  m.def(
      ...
      [](py::array_t<float> q, py::array_t<float> k, py::array_t<float> v, float scale, bool causal) {
        ...
        py::array_t<float> out({static_cast<py::ssize_t>(bh), static_cast<py::ssize_t>(seq), static_cast<py::ssize_t>(dk)});
        py::array_t<float> probs({static_cast<py::ssize_t>(bh), static_cast<py::ssize_t>(seq), static_cast<py::ssize_t>(seq)});
        nimbleml::sdpa_forward_cpu(static_cast<const float*>(qbuf.ptr), static_cast<const float*>(k.request().ptr),
                                   static_cast<const float*>(v.request().ptr), static_cast<float*>(out.request().ptr),
  ...
  m.def(
      ...
      [](py::array_t<float> grad_out, py::array_t<float> q, py::array_t<float> k, py::array_t<float> v,
        ...
        const auto seq = static_cast<std::size_t>(qbuf.shape[1]);
        const auto dk = static_cast<std::size_t>(qbuf.shape[2]);
        py::array_t<float> gq({static_cast<py::ssize_t>(bh), static_cast<py::ssize_t>(seq), static_cast<py::ssize_t>(dk)});
        py::array_t<float> gk({static_cast<py::ssize_t>(bh), static_cast<py::ssize_t>(seq), static_cast<py::ssize_t>(dk)});
        py::array_t<float> gv({static_cast<py::ssize_t>(bh), static_cast<py::ssize_t>(seq), static_cast<py::ssize_t>(dk)});
        nimbleml::sdpa_backward_cpu(static_cast<const float*>(grad_out.request().ptr), static_cast<const float*>(qbuf.ptr),
                                    static_cast<const float*>(k.request().ptr), static_cast<const float*>(v.request().ptr),
                                    static_cast<const float*>(probs.request().ptr), static_cast<float*>(gq.request().ptr),
                                    static_cast<float*>(gk.request().ptr), static_cast<float*>(gv.request().ptr), bh, seq, dk, scale);
