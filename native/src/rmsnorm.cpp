...
namespace nimbleml {
  ...
  void rmsnorm_forward_cpu(const float* x, const float* gamma, float* out, float* ms,
                          float* rms, std::size_t rows, std::size_t dim, float eps) {
  ...
  void rmsnorm_backward_cpu(const float* grad, const float* x, const float* gamma, const float* ms, const float* rms,
